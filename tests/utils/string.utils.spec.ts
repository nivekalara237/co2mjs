...
describe("StringUtils", () => {
    ...
    describe("trimRight", () => {
        ...
        it('should trim char string in the rigth side: chars specified', () => {
            expect(StringUtils.trimRight("aa the apple a","a")).toEqual("aa the apple ");
            expect(StringUtils.trimRight("aaa the appleaaaa","a")).toEqual("aaa the apple");
            expect(StringUtils.trimRight("    the apple  aaaa","a")).toEqual("    the apple  ");
        });
    })
    ...
    describe("trimLeft", () => {
        ...
        it('should trim space string in the left side: no chars specified', () => {
            ...
            expect(StringUtils.trimLetf("  " +
                " \n\t  the apple  ")).toEqual("the apple  ");
        });
        it('should trim char string in the left side: chars specified', () => {
            expect(StringUtils.trimLetf("aa the apple a","a")).toEqual(" the apple a");
            expect(StringUtils.trimLetf("aaathe apple a","a")).toEqual("the apple a");
            expect(StringUtils.trimLetf("aaaa    the apple","a")).toEqual("    the apple");
        });
    })
    ...
    it('should concat strings', () => {
        expect(StringUtils.concat("the", " ", "green ", "apple"))
            .toEqual("the green apple")
    });

    it('should capitalized string', () => {
        expect(StringUtils.capitalisedFirst("the apples"))
            .toEqual("The apples");
    ...
    describe("stringify", ()=> {
        ...
        it('should stringify a bigint value', () => {
            expect(StringUtils.stringify(9789707070709707708n)).toEqual("9789707070709707708");
        });
        ...
        it('should stringify a object value', () => {
            expect(StringUtils.stringify({name: "apple",   weight: 67})).toEqual("{\"name\":\"apple\",\"weight\":67}");
        });
