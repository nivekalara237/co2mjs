...
describe('Test boolean utilities', () => {
  ...
  it("Should throw error [and]", ()=> {
    expect(() => BooleanUtils.and(null)).toThrow("The andValues must an non-empty array");
    expect(() => BooleanUtils.and(...[])).toThrow("The andValues must an non-empty array");
  })
  ...
  it("Should throw error [or]", ()=> {
    expect(() => BooleanUtils.or(null)).toThrow("The orValues must an non-empty array");
    expect(() => BooleanUtils.or(...[])).toThrow("The orValues must an non-empty array");
  })
  ...
  it('should convert number to boolean', () => {
    expect(() => BooleanUtils.numberToBoolean(3, 0, 0)).toThrow("Illegal(s) argument(s) passed");
    ...
    expect(() => BooleanUtils.numberToBoolean(3, 1,0)).toThrow("The number did not match either specified value");
  });

  it('should convert string to boolean', () => {
    expect(() => BooleanUtils.stringToBoolean("ok", "ok", "ok")).toThrow("Illegal(s) argument(s) passed");
    ...
    expect(() => BooleanUtils.stringToBoolean("yes", "ok","ko")).toThrow("The characters did not match either specified value");
  });
  ...
  it("Should throw error [xor]", ()=> {
    expect(() => BooleanUtils.xor(null)).toThrow("The xorValues must an non-empty array");
    expect(() => BooleanUtils.xor(...[])).toThrow("The xorValues must an non-empty array");
  })
