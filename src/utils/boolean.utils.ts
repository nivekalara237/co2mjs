...
export class BooleanUtils {
   ...
   */
  public static toBoolean = (value: boolean | bigint | number | string | null | undefined ) => {
    if (ObjectUtils.isNullOrUndefined(value)) {
      return false;
      ...
      const _true = ["on","yes","y","true","t","ok"].includes(value.toLowerCase());
      const _false = ["off","no","n","false","f","ko"].includes(value.toLowerCase());
   ...
   */
  public static numberToBoolean = (value: number, trueNumber: number, falseNumber: number) => {
   ...
   * @throws Error Value no match none specified value
   */
  public static stringToBoolean = (value: string, trueStr: string, falseStr: string): boolean => {
  ...
  public static toNumber = (value: boolean, trueNumber: number, falseNumber: number): number => {
    return value ? trueNumber : falseNumber;
  };

  public static toChars = (value: boolean, trueStr: string, falseStr: string): string => {
